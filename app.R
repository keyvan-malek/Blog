...
ui <- fluidPage(  
  ...
  fluidRow( 
    ...
    # The fluidRow command gives us the felexibility to define our layout column and offset commands are two of the popular arguments
    # that can be used to generate our layout
    # There are also other predefined layout avaialble in R-Shiny such as side bar layout, vertical layout and split layout
...
server<-function(input, output){ 
 ...
 # Here our code recieves the number that will be set by users through the slider widget
